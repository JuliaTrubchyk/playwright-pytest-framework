...
def test_checkout_fields_accept_valid_information(checkout_page: CheckoutPage):
...
def test_continue_button_navigates_to_checkout_overview(checkout_page: CheckoutPage, first_name, last_name, postal_code):
